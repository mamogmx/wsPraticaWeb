...
require_once(LIB.'praticawebType.class.php');
require_once(LIB.'praticawebMethod.class.php');

// Initialize the PhpWsdl class
require_once(LIBWSDL.'class.phpwsdl.php');
...
$soap=PhpWsdl::CreateInstance(
    ...
    LIBWSDL.'cache',					// Change this to a folder with write access
    Array(								// All files with WSDL definitions in comments
            LIB.'praticawebType.class.php',
            LIB.'praticawebMethod.class.php'
    ),
